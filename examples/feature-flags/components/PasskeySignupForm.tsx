...
import { registerPasskey } from '@cloudwerk/auth/client'
    ...
    return (
        <form onSubmit={handleSubmit} class="space-y-4">
            ...
            <button
                type="submit"
                disabled={loading}
                class="w-full flex items-center justify-center gap-3 px-4 py-3 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition-colors font-medium mt-6 disabled:opacity-50 disabled:cursor-not-allowed"
            >
