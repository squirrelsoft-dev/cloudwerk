...
export function generateServerEntry(
  ...
  // Note: Worker polyfills (MessageChannel, document) are injected via
  // Rollup's `banner` option in the build command, ensuring they execute
  // before any module imports. Placing them in source code doesn't work
  // because Rollup hoists imports above inline code.
